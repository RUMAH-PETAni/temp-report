...
function drawSankey() {
  ...
  // Gunakan lebar dari container, bukan window
  let containerWidth = document.querySelector(".sankey-container").clientWidth;
  let width = Math.max(containerWidth, 300);
  let height = parseInt(svg.style("height"));

  // Atur agar responsif menggunakan viewBox
  svg
    .attr("width", "100%")
